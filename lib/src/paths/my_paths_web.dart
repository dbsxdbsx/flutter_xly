...
/// Bootstrap（[MyUserDataDirectoryStore] 等）依赖 `dart:io`，Web 目标请勿 import 全家桶路径辅助类。
class MyPaths {
  MyPaths._();
  ...
  static Future<Never> userDataFile(String relativePath) =>
      _unsupportedAsync();
  ...
  static const String _message =
      'Web 平台不支持 MyPaths 文件 API；请使用浏览器存储或后端。';
}
